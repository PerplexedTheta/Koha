...
subtest 'Search patrons in modal' => sub {
    ...
    subtest 'Add funds - double' => sub {
        ...
        is(
            $driver->find_element('//div[@id="patron_search_modal_users"]//div[@class="info alert alert-info"]')->get_text,
        ...
        is(
            $driver->find_element('//div[@id="patron_search_modal_users"]//div[@class="error alert alert-warning"]')->get_text,
